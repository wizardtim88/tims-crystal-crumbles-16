...
const BookAdvertisement: React.FC = () => {
  ...
  return (
    <div className="w-full max-w-2xl mx-auto my-6 px-4">
      <div className={cn(
        "relative bg-gradient-to-br from-wizard-purple/20 via-wizard-gold/10 to-wizard-cream/20",
        "backdrop-blur-sm border border-wizard-gold/30 rounded-lg shadow-lg",
        "p-4 sm:p-6 overflow-hidden group hover:shadow-xl transition-all duration-300"
      )}>
        {/* Magical sparkles */}
        ...
        <div className="relative z-10 flex flex-col sm:flex-row items-center gap-4">
          ...
          <div className="flex-shrink-0">
            <div className={cn(
              "w-16 h-16 sm:w-20 sm:h-20 bg-wizard-purple/20 rounded-lg",
              "flex items-center justify-center border border-wizard-purple/30",
          ...
          <div className="flex-1 text-center sm:text-left">
            ...
            <p className="text-sm sm:text-base text-gray-700 font-scroll leading-relaxed mb-3">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-2 text-xs text-gray-600">
              ...
              <span className="font-scroll italic">By Joseph Eleam and Tim Canada</span>
            </div>
          </div>
          ...
          <div className="flex-shrink-0">
            <Button
              ...
              className={cn(
                "bg-wizard-purple hover:bg-wizard-purple/80 text-white font-wizard",
