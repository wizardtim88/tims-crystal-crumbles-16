...
const OnboardingModal: React.FC<OnboardingModalProps> = ({ isOpen, onClose }) => {
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md mx-auto bg-card/95 backdrop-blur-sm border border-primary/30">
        ...
        <div className="space-y-4 text-center">
          <div className="space-y-3 font-scroll text-foreground/90">
            ...
            <div className="bg-muted/50 rounded-lg p-3 border border-primary/20">
              <p className="text-xs font-medium text-primary mb-1">What can I do for you?</p>
              <ul className="text-xs space-y-1 text-left">
                <li>🔮 <strong>Crystal Ball Fortunes</strong> - Ask about love, career, health, or life in general</li>
          ...
          <Button 
            onClick={onClose}
            className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-wizard"
          >
