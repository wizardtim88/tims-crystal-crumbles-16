...
const ShareButton: React.FC<ShareButtonProps> = ({ reading }) => {
  ...
  const templates = [
    ...
    () => {
      const hooks = [
        "Ever wonder what the universe is trying to tell you?",
        "What if I told you the cards knew something you didn't?",
        "Ready for some cosmic truth?",
        "The universe just dropped some wisdom..."
      ];
    ...
    () => {
      const scenarios = [
        "POV: You're scrolling and need a sign...",
        "Me: *shuffles tarot deck* Also me:",
        "When you ask the universe for clarity:",
        "Plot twist: The cards always know"
      ];
    ...
    () => {
      const mysteries = [
        "The cards revealed something wild today...",
        "This gave me CHILLS 👻",
        "Not me getting called out by a tarot card...",
        "The universe said what it said ✨"
      ];
    ...
    () => {
      const timVoice = [
        "Tim here with your cosmic tea ☕",
        "Your boy Tim shuffled the deck and...",
        "Tim's crystal ball is GLOWING today:",
        "Not Tim serving spiritual facts again 💅"
      ];
      ...
      <div className="bg-wizard-dark/20 border border-wizard-gold/20 rounded-lg p-3">
        <div className="flex items-center justify-between mb-2">
          ...
          <Button
            ...
            variant="ghost"
            size="sm"
            className="text-wizard-cream/70 hover:text-wizard-cream p-1 h-auto"
          >
